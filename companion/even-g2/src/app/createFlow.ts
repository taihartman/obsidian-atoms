...
type CommitResponse = { state: "queued" | "saved" | "title_collision" | "setup_required" | "rejected"; outboxId?: string; receipt?: DeliveryReceipt };
...
export type CreateRecoveryRecord = {
  state: "prepared" | "queued" | "saved" | "rejected" | "title_collision" | "revoked";
  recordingId: string;
  capturedAt: string;
...
export class CreateFlow {
  ...
  private view(): CreateView {
    ...
    if (this.record.state === "queued") return { state: "queued", message: CREATE_COPY.queued };
