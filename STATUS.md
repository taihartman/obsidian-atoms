...
|---|---|---|---|---|---|---|
| In progress | #137 | Tai | `feat/ask-mirror-parity` | `docs/plans/2026-07-27-005-feat-ask-mirror-parity-plan.md` | `plus-service/src/mirror/http.mjs`, `plus-service/src/store/ask*Methods.mjs`, `plus-service/src/store/memory.mjs`, `src/platform/askMirror.ts`, `src/platform/plusClient.ts`, `src/plugin/main.ts`, `src/settings/settings.ts` | Vault↔mirror sync system — plan ready, awaiting impl go |
