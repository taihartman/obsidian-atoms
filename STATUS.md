...
|---|---|---|---|---|---|---|
| In progress | [#382](https://github.com/taihartman/obsidian-atoms/issues/382) | taihartman | `claude/atoms-capture-play-store-24f197` | [handoff](docs/handoffs/2026-08-07-android-play-store-listing.md) | `companion/android/app/build.gradle.kts`, `companion/android/app/src/main/AndroidManifest.xml`, `www/src/privacy.html.tmpl` | Atoms Capture → Google Play: SAF-only `play` flavor (drops `MANAGE_EXTERNAL_STORAGE`), release signing scaffold, version off `-poc`, companion section in the privacy policy · no plugin bump |
