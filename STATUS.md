...
|---|---|---|---|---|---|---|
| In progress | [#339](https://github.com/taihartman/obsidian-atoms/issues/339) | taihartman | `feat/339-ask-search-recall-honesty` | [plan](docs/plans/2026-08-06-004-feat-ask-search-recall-and-agent-honesty-plan.md) | `plus-service/src/store/askHelpers.mjs`, `plus-service/src/mcp/*`, store backends | Search honesty + expand; PR #340 open · **0.6.87** · master merged, `ASK_PRIVACY_ACK_VERSION` bumped to `2026-08-07` against the seven-clause wording, `ASK_EXPAND_ENABLED` now defaults on. Shipping tail in progress |
