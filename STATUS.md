...
|---|---|---|---|---|---|---|
| In progress | #119 | Tai | `feat/ask-chatgpt-mcp` | `docs/plans/2026-07-27-006-feat-ask-chatgpt-mcp-plan.md` | `plus-service/src/oauth/*`, `src/settings/settings.ts` | ChatGPT connector path — plan ready, awaiting impl |
