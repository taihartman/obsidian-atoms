...
|---|---|---|---|---|---|---|
| In progress | [#390](https://github.com/taihartman/obsidian-atoms/issues/390) | taihartman | `feat/hub-projection-any-hub` | [plan](docs/plans/2026-08-09-001-feat-hub-projection-any-hub-plan.md) | `src/pipeline/runHubProjection.ts`, `hubQualify.ts`, `classify.ts`, `settings.ts`, `enrich/listHubs.ts` | List hubs + Movies projection; constitution widen |
