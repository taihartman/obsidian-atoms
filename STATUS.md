...
|---|---|---|---|---|---|---|
| In progress | #255 #259 | tai | feat/ask-mcp-mirror-status-whoami | docs/plans/2026-08-04-003-feat-ask-mcp-mirror-status-plan.md | plus-service/src/mcp/tools.mjs, instructions.mjs, askHelpers.mjs | mirror_status + absence wording; Fly-only |
