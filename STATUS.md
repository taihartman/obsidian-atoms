...
|---|---|---|---|---|---|---|
| In progress | [#367](https://github.com/taihartman/obsidian-atoms/issues/367) | taihartman | `chore/367-auto-tag-release` | light | `.github/workflows/release.yml`, `docs/runbooks/plugin-release-beta-stable.md`, `CLAUDE.md` | Auto-Release on master when version has no tag — stops Community delist |
