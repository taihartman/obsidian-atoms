...
|---|---|---|---|---|---|---|
| In progress | [#379](https://github.com/taihartman/obsidian-atoms/issues/379) | taihartman | `feat/379-ios-companion-capture` | [plan](docs/plans/2026-08-07-003-feat-ios-companion-capture-poc-plan.md) | `companion/ios/**` | iOS Capture POC · impl-ready plan · core+app scaffold · PR #380 · worktree `../obsidian_plugin-379-ios-companion-capture` · needs device dogfood + screenshots |
